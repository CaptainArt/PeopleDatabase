...
<head>
	...
	<link rel="stylesheet" type="text/css" href="select_styles.css">
		...
		<div id="GeneralBlockCentral">
			<div id="GeneralBlockCentralHeader">
				<ul>
					...
					<li id="GeneralBlockCentralHeaderFourLi" class="GeneralBlockCentralHeaderLi">Izvēlēties</li>
				</ul>
			</div>
			<img src="../img/bloknot.png">
			<div id="GeneralBlockCentralContentBlock">
				<h2>Ievadi personas kodu</h2>
				<form method="post" action="../selected/selected.php">
