...
<head>
	...
	<link rel="stylesheet" type="text/css" href="delete_styles.css">
		...
		<div id="GeneralBlockCentral">
			<div id="GeneralBlockCentralHeader">
				<ul>
					...
					<li id="GeneralBlockCentralHeaderSecondLi" class="GeneralBlockCentralHeaderLi">Dzēst</li>
			...
			<div id="GeneralBlockCentralContentBlock">
				...
				<form method="post" action="../deleted/deleted.php">
