<?php
	...
	echo "<h4>Vārds</h4>";
	echo "<input type=\"text\" readonly class=\"GeneralBlockCentralContentBlockInputText\" value=\""; echo $select2_array[0] . "\">";
	echo "<br>";
	echo "<h4>Uzvārds</h4>";
	echo "<input type=\"text\" readonly class=\"GeneralBlockCentralContentBlockInputText\" value=\""; echo $select2_array[1] . "\">";
	echo "<br>";
	echo "<h4>Personas kods</h4>";
	echo "<input type=\"text\" readonly id=\"GeneralBlockCentralContentBlockInputPersonalCode1\">-<input type=\"text\" readonly id=\"GeneralBlockCentralContentBlockInputPersonalCode2\">";
	echo "<br>";
	echo "<h4>Telefona numurs</h4>";
	echo "<input type=\"text\" readonly class=\"GeneralBlockCentralContentBlockInputText\" value=\""; echo $select2_array[2] . "\">";
?>