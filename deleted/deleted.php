...
<head>
	...
	<link rel="stylesheet" type="text/css" href="deleted_styles.css">
	...
	<div id="GeneralBlock">
		...
		<div id="GeneralBlockCentral">
			...
			<div id="GeneralBlockCentralContentBlock">
				...
				<h3>Izdzēs personu spiežot pogu "Dzēst"</h3>
				<form>
					...
					<input type="text" readonly class="GeneralBlockCentralContentBlockInputText">
					<br>-->
					<input type="submit" value="Dzēst" id="GeneralBlockCentralContentBlockButtonSubmit">
				</form>
			</div>
		</div>
